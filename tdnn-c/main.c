...
static TDNet createHouNet() {
	...
	TDLayer l1 = createTDLayer(0, "cnn1.conv", CONV, RELU, 128, &kernel_shape1, time_offsets1, 8, &input_shape1, 9);
	...
	TDLayer l2 = createTDLayer(1, "cnn2.conv", CONV, RELU, 64, &kernel_shape2, time_offsets2, 4, &input_shape2, 7);
	...
	TDLayer l3 = createTDLayer(2, "cnn3.conv", CONV, RELU, 64, &kernel_shape3, time_offsets3, 4, &input_shape3, 5);
	...
	TDLayer l4 = createTDLayer(3, "Affine1", DENSE, RELU, 512, &kernel_shape4, time_offsets4, 3, &input_shape4, 1);
	...
	TDLayer l5 = createTDLayer(4, "Affine2", DENSE, RELU, 512, &kernel_shape5, time_offsets5, 1, &input_shape5, 1);
	...
	TDLayer l6 = createTDLayer(5, "Affine3", DENSE, RELU, 512, &kernel_shape6, time_offsets6, 1, &input_shape6, 1);
	...
	TDShape input_shape6 = { 1, 512, 1 };
	int time_offsets6[1] = { 0 };*/
	TDLayer l7 = createTDLayer(6, "Final_affine", DENSE, NONE, 67, &kernel_shape6, time_offsets6, 1, &input_shape6, 1);
...
static inputOneFrame(const float *oneFrame) {
